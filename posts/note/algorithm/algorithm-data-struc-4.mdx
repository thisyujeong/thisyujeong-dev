...
date: 2022-08-08
tags: ['algorithm', 'data structure', '자료구조', '알고리즘', '다중 포인터']
---

> [JavaScript 알고리즘 & 자료구조 마스터 클래스](!https://www.udemy.com/course/best-javascript-data-structures/) 강의를 듣고 작성하는 강의노트 4  
...
오름차순으로 정렬된 배열을 인자로 받는 `sumZero` 함수로, 함계가 0인 첫번째 쌍을 찾는다.
