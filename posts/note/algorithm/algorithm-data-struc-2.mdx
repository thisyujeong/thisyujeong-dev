---
title: 배열과 오브젝트의 성능 평가 (Big O)
date: 2022-08-07
tags: ['algorithm', 'data structure', '자료구조', '알고리즘', 'Big O', '빅오']
---

> [JavaScript 알고리즘 & 자료구조 마스터 클래스](!https://www.udemy.com/course/best-javascript-data-structures/) 강의를 듣고 작성하는 강의노트 2
